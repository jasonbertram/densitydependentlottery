...
Unlike Grime's classic ternary plot for observed traits \citep{grime_1974}, our realization of Grime's triangle (Fig. 4) refers only to the direction of trait evolution. Whereas a ternary plot represents anti-correlation between traits relevant for success in different environmental archetypes, our triangle reflects the underlying environmental limits of survival.  

We have made no appeal to, or attempted to explain, trade-offs between traits .  





given that $b$ is closely related to the low-density reproductive rate $r=b-d$, and the opposite outcome is expected in MacArthur's $r$/$K$ dichotomy \citep{macarthur_1962}.


Apart from the prediction of evolution for higher $b$ in ideal environments, 

The model developed here is a density-dependent generalization of the classic lottery model (Results section). 
