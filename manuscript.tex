...
In the broader context of eco-evolutionary synthesis [? Cite], we can imagine a spectrum of approaches ranging from population genetics, which is entirely evolutionary (no ecology) and has a strong emphasis on genetics, to pure ecological theory with no evolution. 
