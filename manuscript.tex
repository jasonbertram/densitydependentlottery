...
\subsection{Invasion of rare genotypes and coexistence}
...
\end{equation}
Eq. \eqref{eq:iinvadcoex} is satisfied by assumption, while Eq. \eqref{eq:jinvadcoex} can always be satisfied with large enough $c_j$. The mechanism for coexistence is that territorial contests are important in $i$-dominated populations (high $L$), ensuring that the $c$-specialist $j$ is not excluded, yet territorial contests are irrelevant in $j$-dominated populations (low $L$), ensuring that the $b$-specialist $i$ is not excluded. Fig. \ref{fig:coex} shows an example of this coexistence between $b$ and $c$ specialists. 
