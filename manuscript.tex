...
In MacArthur's view, selection at high densities is ``$K$-selection'', such that in ``crowded populations ... fitness is $K$''. MacArthur's argument is based on general equations for density-regulated population growth
\begin{equation}
