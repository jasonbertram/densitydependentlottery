...
In our extension of the classic lottery model, we do not restrict ourselves to high propagule densities, and the propagule composition in different territories will deviate appreciably from $l_1,l_2,\ldots,l_G$. We expect that a fraction $p_1(x_1)\ldots p_G(x_G)$ of the $U$ unoccupied territories will have the propagule composition $x_1,\ldots,x_G$. Genotype $i$ is expected to win win $c_i x_i/\sum_j c_j x_j$ of these $p_1(x_1)\ldots p_G(x_G) U(t)$ territories.
