...
MacArthur famously distinguished between ``$r$-selection'' for faster growth at low population density, and ``$K$-selection'' for the ability to keep growing at high densities \citep{macarthur_1962,macarthur_1967}. While the $r$/$K$ scheme is primarily known for its seminal role in the study of life-history evolution \citep{pianka_1970,boyce_1984,charlesworth_1994,reznick_2002}, it
