...
also initiated a sizeable literature on density-dependent selection. This literature is remarkable in that it contains some of earliest models of the interplay between ecology and evolution \citep{roughgarden_1979,travis_2013}, 

Identifying selection at high densities with ``$K$-selection'' is a compelling oversimplification. Starting from a very general description of density-regulated population growth
\begin{equation}
\frac{d n_1}{d t}=f_1(n_1,n_2)\qquad\frac{d n_2}{d t}=f_2(n_1,n_2)
\end{equation}

``population genetics of crowded populations where fitness is $K$''. 
