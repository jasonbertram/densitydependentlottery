...
Here we only consider the last of these factors. To account for the first two factors would require an evaluation of the effects of mutations on traits subject to trade-offs, which is beyond the scope of this article. Thus, we consider how selection alone shapes the direction of evolution for $b$, $c$ and $d$, assuming that mutations affect them independently and with the same distribution of beneficial fitness effects. 
