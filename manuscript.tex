...
MacArthur famously distinguished between ``$r$-selection'' for faster growth at low population density, and ``$K$-selection'' for the ability to keep growing at higher densities \citep{macarthur_1962,macarthur_1967}. The $r$/$K$ scheme is mostly known, and critiqued, for its role in the study of life-history evolution \citep{pianka_1970,boyce_1984,charlesworth_1994,reznick_2002}. The $r$/$K$ scheme also initiated a sizeable literature on density-dependent selection  (note that Kostitzin presented similar ideas much earlier \citep{kostitzin_1939,christiansen_2004}). This literature is remarkable in that it contains some of earliest explicit analyses of the interplay between ecology and evolution \citep{travis_2013}, yet it has left a complex legacy.

Although $r$ and $K$ are named after the parameters of the logistic model, $K$ generally refers to carrying capacity regardless of how the density regulation of population size occurs \citep{macarthur_1967}. Yet the ability to keep growing at ever higher densities is only one aspect of selection at high population density. Competition is critically important at high densities, and cannot be represented solely in terms of the density regulation of total population size. This led to the notion of ``$\alpha$-selection'' after the competition coefficients in the Lotka-Volterra equations \citep{gill_1974,case_1974,joshi_2001}. 
...
It is thus broadly misleading to view $r$- and $K$-selection as two main contrasting forms of selection, and the widespread use of the logistic model in the density-dependent literature is more problematic than simply being a mathematical idealization [citations].
