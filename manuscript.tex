...
In the Introduction we outlined MacArthur's general argument. Here we discuss out some further aspects of

compare MacArthur's claims about selection in crowded populations with our density-dependent lottery model. but did not specify the role of ``$K$''. 

revolving around the shape of the nullclines $f_1(n_1,n_2)=0$ and $f_2(n_1,n_2)=0$ of Eq.~\eqref{eq:macgeneral}
