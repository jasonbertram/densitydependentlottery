...
\caption{\label{fig:Ksel} (a) MacArthur's dynamical argument for why ``fitness is $K$'' in crowded environments, illustrated using the logistic model in Eq. \eqref{eq:macgeneral}. The type that  (b) The constant-$N$, relative fitness description of selection.}
\end{figure}
...
Here we compare $K$-selection and MacArthur's broader claims about selection in crowded populations with our density-dependent lottery model. To do so we first need to clarify MacArthur's particular use of ``$K$''.
