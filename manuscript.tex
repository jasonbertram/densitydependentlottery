...
In MacArthur's view, ``$K$-selection'' is how selection operates at high densities, such that in ``crowded populations ... fitness is $K$'' \citep[pp. 149]{macarthur_1967}. 

MacArthur's argument is based on general equations for density-regulated population growth
\begin{equation}
\frac{d n_1}{d t}=f_1(n_1,n_2)\qquad\frac{d n_2}{d t}=f_2(n_1,n_2),
\end{equation}
where, by definition, each 
