...
MacArthur's argument is based on very general 
\begin{equation}
\frac{d n_1}{d t}=f_1(n_1,n_2)\qquad\frac{d n_2}{d t}=f_2(n_1,n_2),
\end{equation}
where $n_1$ and $n_2$ are the respective densities of the two types, and the growth rates $f_1$ and $f_2$ decrease with both $n_1$ and $n_2$. 
