...
U=100000
ls=np.array([[x*0.1,x] for x in np.linspace(0.01,20,50)])
...
ax1.plot(ls[:,0],(exact[:,0,0]+exact[:,1,0]+exact[:,2,0])/(ls[:,0]*U),'ko',markersize=6,markerfacecolor='None',label="Simulation")
ax1.plot(ls[:,0],exact[:,0,0]/(ls[:,0]*U),'ko',markersize=6,markerfacecolor='None')
ax1.plot(ls[:,0],exact[:,1,0]/(ls[:,0]*U),'ko',markersize=6,markerfacecolor='None')
ax1.plot(ls[:,0],exact[:,2,0]/(ls[:,0]*U),'ko',markersize=6,markerfacecolor='None')
...
ax2.plot(ls[:,1],(exact[:,0,1]+exact[:,1,1]+exact[:,2,1])/(ls[:,1]*U),'ko',markersize=6,markerfacecolor='None',label="Simulation")
...
ax2.plot(ls[:,1],exact[:,0,1]/(ls[:,1]*U),'ko',markersize=6,markerfacecolor='None',label="Simulation")
ax2.plot(ls[:,1],exact[:,1,1]/(ls[:,1]*U),'ko',markersize=6,markerfacecolor='None')
ax2.plot(ls[:,1],exact[:,2,1]/(ls[:,1]*U),'ko',markersize=6,markerfacecolor='None')
